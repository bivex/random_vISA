...
class CPP14Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CPP14Parser#initStatement.
    def visitInitStatement(self, ctx:CPP14Parser.InitStatementContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#simpleTypeNameSpecifier.
    def visitSimpleTypeNameSpecifier(self, ctx:CPP14Parser.SimpleTypeNameSpecifierContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#theTypeIdList.
    def visitTheTypeIdList(self, ctx:CPP14Parser.TheTypeIdListContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CPP14Parser#classVirtSpecifierSeq.
    def visitClassVirtSpecifierSeq(self, ctx:CPP14Parser.ClassVirtSpecifierSeqContext):
        return self.visitChildren(ctx)
