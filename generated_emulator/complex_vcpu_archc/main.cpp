...
int sc_main(int ac, char *av[]) {
    ...
    if (has_app) {
        ...
        if (!bin_path.empty()) {
            ...
            uint32_t w0 = ((0 & 0x3F) << 26) | (1 << 25) | (2 << 20) | (1 << 15) | (2 << 12) | ((0 + 4) << 7) | 0x57;
            write_word(proc1, addr, w0);
            addr += 4;
            // Instruction vor_vi_1
            uint32_t w1 = ((1 & 0x3F) << 26) | (1 << 25) | (2 << 20) | (5 << 15) | (3 << 12) | ((1 + 4) << 7) | 0x57;
            ...
            uint32_t w5 = ((5 & 0x3F) << 26) | (1 << 25) | (2 << 20) | (1 << 15) | (4 << 12) | ((5 + 4) << 7) | 0x57;
            ...
            uint32_t w7 = ((7 & 0x3F) << 26) | (1 << 25) | (2 << 20) | (1 << 15) | (2 << 12) | ((7 + 4) << 7) | 0x57;
